        ...
        <div className="bg-white min-h-screen pb-24">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-undefined items-center">
                        <motion.div
            ...
            <section className="py-10 md:py-undefined bg-gray-50/50">
            ...
            {/* CTA */}
            <section className="py-10 md:py-undefined">
